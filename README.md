<h1 align="left">Job Recruitment Database</h1>
...
<h3>SQL Showcase</h3>
<img width="750" alt="all tables sc" src="https://github.com/user-attachments/assets/202cdba5-649c-49eb-85ec-f1edeb9e6d0d">
<img width="750" alt="joblistings sc" src="https://github.com/user-attachments/assets/a618f3a4-e518-4a66-a456-8c185321165d">

<h3>Java Showcase</h3>
<img width="500" alt="java sc" src="https://github.com/user-attachments/assets/b4da03e1-49cb-4494-8227-63d4479d6beb">
...
<p align="left">In order to use the database, you must use the provided schema.sql file and import this into your own database. Steps to do this can be found <a href="https://support.hostinger.com/en/articles/1884149-how-to-import-a-database-with-phpmyadmin">here</a>.</p>
...
<h2>Common Errors</h2>
<p>- Ensure you have configured the build path of the project, to point towards your download for the MySQL Connector file</p>
<img width="670" alt="Screenshot 2024-10-04 205753" src="https://github.com/user-attachments/assets/89a9c1c2-96ef-4d39-89a7-6672b9375d65">

<p>- If the error is to do with the downloaded Java code, please make sure you replace <b>ALL</b> commented out code with references to your own database.</p>
